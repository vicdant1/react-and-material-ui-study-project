  ...
  return (
    <div className="page">
      <Grid container spacing={3}>
        <Grid className={classes.teste} item xs={12} sm={10}>
          <Typography variant="body1" align="justify">
            ...
            quasi quidem in repellat provident quam quod porro, magnam molestiae
            numquam consequuntur. Ducimus velit id rem quo voluptatibus maiores
            porro nemo. Quidem perspiciatis veritatis totam! Incidunt odio,
            commodi, assumenda veniam id vel sed molestias eum magnam reiciendis
            iure quidem. Veritatis cupiditate sint explicabo aut, quia inventore
            distinctio at laborum quis, modi illo animi, ad deserunt.
          </Typography>
          <hr />
          <Typography variant="body1" align="justify">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam
